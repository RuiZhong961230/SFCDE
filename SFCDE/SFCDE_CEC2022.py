...
def RunSFCDE(func):
    ...
    np.savetxt("./SFCDE_Data/CEC2022/F" + str(FuncNum) + "_" + str(DimSize) + "D.csv", All_Trial_Best, delimiter=",")
...
def main(dim):
    ...
    for i in range(len(CEC2022)):
        FuncNum = i + 1
        RunSFCDE(CEC2022[i].evaluate)


if __name__ == "__main__":
    if os.path.exists('./SFCDE_Data/CEC2022') == False:
        os.makedirs('./SFCDE_Data/CEC2022')
    Dims = [10, 20]
    for Dim in Dims:
        main(Dim)
