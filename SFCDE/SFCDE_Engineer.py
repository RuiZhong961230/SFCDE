...
def RunSFCDE(func):
    ...
    np.savetxt("./SFCDE_Data/Engineer/" + str(FuncNum) + ".csv", All_Trial_Best, delimiter=",")
...
def main():
    ...
    for i in range(len(Probs)):
        ...
        UB = Probs[i].ub
        FuncNum = Names[i]
        RunSFCDE(Probs[i].evaluate)


if __name__ == "__main__":
    if os.path.exists('./SFCDE_Data/Engineer') == False:
        os.makedirs('./SFCDE_Data/Engineer')
    main()
